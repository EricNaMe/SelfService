...
<%@include file="EnlacesHeader.jsp"%>
	<script type="text/javascript" src="js/dwmsTS.js"></script>
</head>
    <body>
...
color:blue;
		...
		<%@include file="LATERALdwms.jsp"%>
		
        <div class="menu-central col-sm-10 col-sm-offset-1" style="margin-bottom:20px; ">
          <div class="col-md-12" style="margin-bottom:20px;">
     		   <h1 class="titulo-plantilla" style="font-weight:bold; text-align:center;">Troubleshooting Sharepoint</h1>
       	    </div>
